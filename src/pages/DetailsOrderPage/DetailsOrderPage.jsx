...
import { WrapperContentInfo, WrapperHeaderUser, WrapperInfoUser, WrapperItem, WrapperItemLabel, WrapperLabel, WrapperNameProduct, WrapperProduct, WrapperStyleContent } from './style';
...
const DetailsOrderPage = () => {
    ...
    const queryOrder = useQuery({
        ...
        enabled: !!id, // Đảm bảo `enabled` là true khi cả `id` và `token` tồn tại
    });

    const { isPending, data } = queryOrder; // Thay `isPending` bằng `isLoading`
                ...
                <div style={{ width: '1270px', margin: '0 auto' }}>
                    ...
                    <WrapperStyleContent>
                        ...
                        {data?.orderItems?.map((order) => {
                            return (
                                <WrapperProduct style={{ marginLeft: '200px' }}>
                                    <WrapperNameProduct>
                                        <img
                                            src={order?.image}
                                            style={{
